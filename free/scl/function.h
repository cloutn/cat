...
public:
    ...
    any_class_function              () { }
    any_class_function              (void* _class, class_function_ptr _func) : m_caller(_class), m_func(_func) { }
...
{
	using type = scl::any_class_function<return_t, args_t...>;
};

template <typename T>
class any_class_function_type : public get_func_base_type<T>::type
{
public:
...
//template <typename T>
//inline class_function_ptr to_func(T func)
//{
//    return reinterpret_cast<class_function_ptr>(func);
//}

template <typename class_t, typename return_t, typename... args_t>
inline any_class_function<return_t, args_t...> make_func(void* caller, return_t (class_t::*pfunc)(args_t...))
{
