...
对照 `doc/代码审查-系统级.md` 中 ownership 相关条目：
...
- [ ] 统一文件命名规范（驼峰 vs snake_case 二选一，写进 `doc/代码审查-规范.md`）
...
> 依据：`doc/物理引擎接入设计与实施计划.md` / `doc/Jolt接入实施步骤.md`
...
- 每个 phase 结束更新 `doc/架构总览.md`
- `子系统-XXX.md` 在引入新模块时同步更新
