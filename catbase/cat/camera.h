...
public:
	...
	void					setOrthoRefPosition			(const scl::vector3& pos) { m_orthoRefPosition = pos; }
...
private:
	...
	float					_orthoRefPositionToZ		() const;
...
private:
	...
	scl::vector3			m_orthoRefPosition; // when calculating otho matrix, the m_orthoRefPosition determine focus Z position rather than use the NearZ.
