...
void test_frustum_infinite(bool print)
{
	...
	// Test all four z_range mappings
	...
	scl::matrix sInfinite_1toneg1 = matrix::frustum_infinite(-frustumW, frustumW, -frustumH, frustumH, near_z, scl::z_range::one_to_negative_one);
	scl::matrix sInfinite_0to1 = matrix::frustum_infinite(-frustumW, frustumW, -frustumH, frustumH, near_z, scl::z_range::zero_to_one);
	scl::matrix sInfinite_1to0 = matrix::frustum_infinite(-frustumW, frustumW, -frustumH, frustumH, near_z, scl::z_range::one_to_zero);
	...
	scl::matrix sRegular_1toneg1 = matrix::frustum(-frustumW, frustumW, -frustumH, frustumH, near_z, very_far, scl::z_range::one_to_negative_one);
	scl::matrix sRegular_0to1 = matrix::frustum(-frustumW, frustumW, -frustumH, frustumH, near_z, very_far, scl::z_range::zero_to_one);
	scl::matrix sRegular_1to0 = matrix::frustum(-frustumW, frustumW, -frustumH, frustumH, near_z, very_far, scl::z_range::one_to_zero);
	
	assert(compare_mat(sInfinite_neg1to1, sRegular_neg1to1, false));
	assert(compare_mat(sInfinite_1toneg1, sRegular_1toneg1, false));
	assert(compare_mat(sInfinite_0to1, sRegular_0to1, false));
	assert(compare_mat(sInfinite_1to0, sRegular_1to0, false));
}
